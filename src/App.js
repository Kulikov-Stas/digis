...
const loaderText = [
    ...
    'We, the DIGIS Company, know how difficult it is for developers\nwithout commercial experience to find their first job.',
];

const loaderTextItem = loaderText.map((text, index) =>
    <p key={index}>
        {text}
    </p>
);

const numRows = loaderTextItem.length;
...
class App extends React.Component {
    ...
    tick() {
        ...
        this.setState({
            iteration: loaderTextItem[this.i]
        });
    }
